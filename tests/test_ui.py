...
def test_apply_sort_and_filters_by_video_size():
    entries = [
        {
            "post_id": "1",
            "metrics": {"largest_video_size": 1024, "videos": 1},
            "order": 0,
        },
        {
            "post_id": "2",
            "metrics": {"largest_video_size": 50_000, "videos": 2},
            "order": 1,
        },
        {
            "post_id": "3",
            "metrics": {"largest_video_size": 2048, "videos": 1},
            "order": 2,
        },
    ]
...
def test_video_metrics_fetch_remote_headers(monkeypatch):
    ...
    dialog._remaining_remote_lookups = 1
